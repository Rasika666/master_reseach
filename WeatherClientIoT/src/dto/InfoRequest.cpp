...
InfoRequest::InfoRequest(String timeStamp, Location location, SystemSettings systemSettings)
    :timeStamp(timeStamp), location(location), systemSettings(systemSettings) {};
